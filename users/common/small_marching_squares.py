...
class SmallMarchingSquare(experiment.Stimulus):
    def configuration(self):
        self.STIMULUS_AREA_WIDTH=1.5#um
        self.STIMULUS_AREA_HEIGHT=1.5#um
        self.PIXEL_SIZE=1.5#um
        self.NROWS=int(self.STIMULUS_AREA_HEIGHT/self.PIXEL_SIZE)
        self.NCOLUMNS=int(self.STIMULUS_AREA_WIDTH/self.PIXEL_SIZE)
        self.BACKGROUND=0.0
        self.COLOR=1.0
